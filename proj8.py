...
import corr,time,numpy,struct,sys,logging,pylab,matplotlib,os

bitstream = 'proj83.bof'
katcp_port = 7147
f = open('testegg.txt','w')
count = 0
countstop=1000000
